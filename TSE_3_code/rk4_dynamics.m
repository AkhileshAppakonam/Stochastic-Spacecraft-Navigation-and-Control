function [g_, V_, tet_] = rk4_dynamics(dt, ti, tf, g0_, V0_)
global lt 
dt2 = dt/2;
dt6 = dt/6;
...
for t = ti: dt: tf
    ...
    [dgmold, dVmold] = dynamics(tt, g0t, V0t);
    V0t = V0_ + dt * dVmold;
    ...
    [dg0t, dV0t] = dynamics(t + dt, g0t, V0t);
